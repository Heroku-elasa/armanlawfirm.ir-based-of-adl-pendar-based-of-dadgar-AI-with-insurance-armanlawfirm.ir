...
const getAI = (): GoogleGenAI => {
    if (!aiInstance) {
        ...
        if (!apiKey) {
            throw new Error("سرویس هوش مصنوعی در دسترس نیست. لطفاً از چت‌بات واتساپ استفاده کنید یا با پشتیبانی تماس بگیرید. (AI service not available. Please use the WhatsApp chatbot or contact support.)");
        }
