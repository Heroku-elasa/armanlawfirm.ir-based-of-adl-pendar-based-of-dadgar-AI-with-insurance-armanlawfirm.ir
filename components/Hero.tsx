          ...
          <div className="container mx-auto px-4">
              <div className="bg-[#bef264]/10 border border-[#bef264]/30 rounded-3xl overflow-hidden flex flex-col md:flex-row">
                  <div className="w-full md:w-1/2 min-h-[300px] relative bg-gray-900 dark:bg-[#111827] flex items-center justify-center group overflow-hidden">
                        <iframe 
                            src="https://maps.google.com/maps?q=35.7621,51.4230&hl=fa&z=16&output=embed"
                  ...
                  <div className="w-full md:w-1/2 p-10 md:p-16 flex flex-col justify-center">
                      ...
                      <div className="mt-8 flex flex-wrap gap-4">
                           ...
                           <a href="https://neshan.org/maps/@35.7621,51.4230,15z" target="_blank" rel="noopener noreferrer" className="flex-1 bg-green-600/10 dark:bg-green-600/20 border border-green-500/30 dark:border-green-500/50 text-green-600 dark:text-green-300 py-2 px-4 rounded-lg hover:bg-green-600/20 dark:hover:bg-green-600/40 transition-colors text-center text-sm font-semibold flex items-center justify-center gap-2">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /></svg>
                                مسیریابی با نشان
                           </a>
                           <a href="https://www.google.com/maps/search/?api=1&query=35.7621,51.4230" target="_blank" rel="noopener noreferrer" className="flex-1 bg-red-600/10 dark:bg-red-600/20 border border-red-500/30 dark:border-red-500/50 text-red-600 dark:text-red-300 py-2 px-4 rounded-lg hover:bg-red-600/20 dark:hover:bg-red-600/40 transition-colors text-center text-sm font-semibold flex items-center justify-center gap-2">
